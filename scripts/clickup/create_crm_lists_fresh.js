...
/**
 * Create CRM Lists Fresh with Short Text Fields
 * 
 * Deletes the empty Customers list and creates all 3 CRM lists with proper short_text field types
 */
...
async function deleteList(listId, listName) {
  console.log(`🗑️  Deleting existing list: ${listName} (${listId})`);
...
async function main() {
  ...
  // Delete the empty Customers list first
  console.log('🧹 Cleaning up existing empty Customers list...\n');
  await deleteList('901321549642', 'Customers');
  ...
  console.log(`\n✅ Customers: ${Object.keys(customersFields).length} fields created`);
  ...
  // ========== SUMMARY ==========
  console.log('\n' + '='.repeat(70));
  console.log('✅ CRM LISTS CREATION COMPLETE!');
  console.log('='.repeat(70));
  console.log('\n📊 Summary:');
